...
inspectable!(grid collider_material ColliderMaterial as ColliderMaterialComponent: friction with NumberAttributes::positive().speed(0.01), restitution with NumberAttributes::normalized().speed(0.01), friction_combine_rule by coefficient_combine_rule, restitution_combine_rule by coefficient_combine_rule);
